...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#EFF4F5", tertiary: "#EFF4F5", text: "#fff", textDisabled: "#BDC2C4", textSubtle: "#6d6d6d", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
