...
var Icon$F = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 52 52" }, props),
        React__default['default'].createElement("image", { width: "52", height: "52", href: "/images/kesef/logo.svg" })));
};
...
var Icon$A = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/kesef/rock_icon.svg" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/kesef/logo.svg" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 52" }, props),
        React__default['default'].createElement("image", { width: "205", height: "52", href: isDark ? "/images/kesef/logoTextDark.svg" : "/images/kesef/logoTextLight.svg" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? React__default['default'].createElement(Icon$l, { width: "24px", color: "text" }) : React__default['default'].createElement(Icon$m, { width: "24px", color: "text" })),
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React__default['default'].createElement(Icon$H, { color: "text", mr: "6px" }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#ffe184", background: "#FFB6C1", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#ffe184", textDisabled: "#BDC2C4", textSubtle: "#ffe184", borderColor: "#E9EAEB", card: "#FFC0CB", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#ffe184", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#ffe184", tertiary: "#353547", text: "#ffe184", textDisabled: "#666171", textSubtle: "#ffe184", borderColor: "#524B63", card: "#27262c", gradients: {
